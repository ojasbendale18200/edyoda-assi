    ...
    <div className="navbar">
      <div className="navbar__container">
        <div className="container__left">
          <p className="container__leftTitle">EDYODA</p>
          <div className="container__leftCourses">
            <p className="container__leftCourses__title">Courses</p>
            <svg
          ...
          <div className="container__leftCourses">
            <p className="container__leftCourses__title">Programs</p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="25"
              height="24"
        ...
        <div className="container__right">
          ...
          <p className="container__right__text">Log in</p>
          <button className="container__right__button">Join now</button>
        </div>
      </div>
    </div>
  );
